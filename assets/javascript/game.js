	...
	function Attack(p1, p2) {
		...
		$("button").on("click", function () {
			...
			if (p1[0].health > 0 && p2[0].health > 0) {
				console.log("both players are alive");

				console.log("player 1 battle health ", p1[0].health);

				console.log("player 2 battle health ", p2[0].health);

				p2[0].health -= p1[0].attackPW;
				console.log(
					"player 1 attacked player 2 for ",
					p1[0].attackPW,
					" damage and player 2 now has ",
					p2[0].health,
					" points left."
				);
				...
				console.log(
					"player 2 counter attacked player 1 for ",
					p2[0].counterPW,
					" damage and player 1 now has ",
					p1[0].health,
					" points left."
				);
